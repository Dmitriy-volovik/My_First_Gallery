...
const addPhotoQuery = async function (props) {
  // console.log(`VOt Ge g On ${props.originalname}`)
  // props.map((photos, id) => {})
  return await gql.request(`mutation createPhoto($albumID: Int, $originalname: String!, $mimetype: String!,
                            $destination: String!, $filename: String!, $path: String!, $size: Int!) {
                        createPhoto(albumID: $albumID, originalname: $originalname, mimetype: $mimetype, destination: $destination, filename: $filename,
                           path: $path, size: $size) {
                            albumID,
                            originalname,
                            mimetype,
